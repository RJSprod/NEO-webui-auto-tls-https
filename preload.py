def preload(parser):
	...
	parser.add_argument("--autotls-http1", action='store_true', help="Keep serving HTTPS over HTTP/1.1 with the WebUI's own server instead of HTTP/2 through Hypercorn", default=False)
